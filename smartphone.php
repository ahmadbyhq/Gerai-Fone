...
<body>
    ...
    <section class="my-5 pt-5">
        <h4 class="text-center text-header fw-bold">Smartphone</h4>

        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-5">
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        <img src="img\hp_kategori.png" alt="Samsung S23 Ultra" />
                        ...
                        <div class="card-body">
                            <h6>Samsung S24 Ultra 8/256 Black</h6>
                            <p>Rp 20.000.000</p>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        <!-- Gambar Produk -->
                        <img src="img/hp_kategori.png" alt="Samsung S23 Ultra" class="img-fluid" />
                        <div class="d-flex justify-content-center gap-1 mt-2">
                            <ion-icon name="star" class="star-icon"></ion-icon>
                            <ion-icon name="star" class="star-icon"></ion-icon>
                            <ion-icon name="star" class="star-icon"></ion-icon>
                        ...
                        <div class="card-body">
                            <h6>Samsung S24 Ultra 12/512 Titanium Black</h6>
                            <p>Rp 25.000.000</p>
                            <button class="btn">Tambah Keranjang</button>
                        </div>
                    </div>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        ...
                        <div class="card-body">
                            <h6>Samsung S24 Ultra 8/256 Titanium Green</h6>
                            <p>Rp 20.000.000</p>
                            <button class="btn">Tambah Keranjang</button>
                        </div>
                    </div>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        ...
                        <div class="card-body">
                            <h6>Samsung S24 Ultra 8/256 Titanium Violet</h6>
                            <p>Rp 20.000.000</p>
                            <button class="btn">Tambah Keranjang</button>
                        </div>
                    </div>
