...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM user WHERE email = ? AND role = 'pelanggan'";
...
<body>
    ...
    <div class="container-login">
        <form id="loginForm" class="login-form needs-validation" novalidate method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="position-relative">
                    <input type="password" name="password" class="form-control pe-5" id="loginPassword" placeholder="Masukkan password"
            ...
            <div class="mb-3 text-end">
                <a href="forgotpassword.php" class="no-blue-link">Lupa password?</a>
            </div>
            ...
            <div class="mt-3 text-center">
                <span>Belum punya akun? <a href="register.php" class="no-blue-link ms-2">Daftar</a></span>
            </div>
        </form>
    </div>
