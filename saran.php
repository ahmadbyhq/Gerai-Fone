...
<body>
    ...
    <nav class="navbar navbar-expand-lg border-bottom py-2 fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center gap-5">
                ...
                <!-- Icons -->
                <div class="d-flex align-items-center gap-5 icon-header">
                    <a href="#" class="text-dark fs-5 d-flex align-items-center">
                        <ion-icon name="cart-outline" class="icon"></ion-icon>
                    </a>
                    <div class="dropdown">
                        <a href="#" class="text-dark fs-5 d-flex align-items-center dropdown-toggle-user"
    ...
    <div class="container py-5 mt-5">
        <div class="row gx-5 g-4 mt-1">
            <div class="col-md-5">
                <div
                    class="card custom-card d-flex flex-column align-items-center justify-content-center text-center h-100">
                    <img src="img/logo.png" alt="Geraifone Logo" class="square-img mb-4">
                    <p class="text-muted  px-3">
                        <strong>Geraifone</strong> adalah website ecommerce yang menjual smartphone dan juga aksesoris
                        smartphonenya seperti casing, charger, TWS, dan power bank.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-7">
                <div class="card custom-card h-100">
                    <h4 class="text-center fw-bold mb-4">Kirim Laporan</h4>
                    <form class="d-flex flex-column h-100">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="message" rows="4"
                                placeholder="Tulis laporan Anda di sini" required></textarea>
                        </div>
                        <div class="mt-auto">
