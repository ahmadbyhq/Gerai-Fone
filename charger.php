...
<body>
    ...
    <section class="my-5 pt-5">
        <h4 class="text-center text-header fw-bold">Charger Smartphone</h4>

        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-5">
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        <img src="img\ugreen_25w.png" alt="Samsung S23 Ultra" />
                        ...
                        <div class="card-body">
                            <h6>Kepala Charger Ugreen 25 Watt</h6>
                            <p>Rp 200.000</p>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        <img src="img\xiaomi_67W.png" alt="Samsung S23 Ultra" />
                        <div class="d-flex justify-content-center gap-1 mt-2">
                            <ion-icon name="star" class="star-icon"></ion-icon>
                            <ion-icon name="star" class="star-icon"></ion-icon>
                            <ion-icon name="star" class="star-icon"></ion-icon>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card product-card text-center">
                        <img src="img\samsung_45w.png" alt="Samsung S23 Ultra" />
                        <div class="d-flex justify-content-center gap-1 mt-2">
                            <ion-icon name="star" class="star-icon"></ion-icon>
                            <ion-icon name="star" class="star-icon"></ion-icon>
                            <ion-icon name="star" class="star-icon"></ion-icon>
